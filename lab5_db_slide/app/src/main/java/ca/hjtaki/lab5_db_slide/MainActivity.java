...
import ca.hjtaki.lab5_db_slide.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create arraylist
        mListView = findViewById(R.id.todo_list);// where, setting, what
        mArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, mTodos);
