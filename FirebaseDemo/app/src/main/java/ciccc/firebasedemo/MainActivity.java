...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //short click
        final Intent intent = new Intent(this, addTrack.class);
    ...
    private void showUpdateDialog(final String id, final String name, String genre){
        ...
        //2-1. set quick listener for update
        Button update_btn = dialogView.findViewById(R.id.dialog_update);
        update_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                final Artist edited_artist = new Artist(id,editText.getText().toString().trim(),spinner.getSelectedItem().toString());
                edited_track.setArtist_name(editText.getText().toString().trim());
                ...
                ref_tracks.child(name).setValue(edited_track, new DatabaseReference.CompletionListener() {
                    @Override
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        Toast.makeText(MainActivity.this,"Successfully updated the Track",Toast.LENGTH_SHORT).show();
        ...
        //2-2. set quick listener for delete
        ...
        delete_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref_tracks.child(name).removeValue(new DatabaseReference.CompletionListener() {
                    @Override
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if(databaseError == null){
                            Toast.makeText(MainActivity.this,"Successfully removed the Track",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    protected void onStart() {
        ...
        ref_tracks.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                edited_track = dataSnapshot.getValue(Track.class);
        ...
        ref_artists.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mArtists.clear();
                for(DataSnapshot eashHistory: dataSnapshot.getChildren()){
                    Artist artist = eashHistory.getValue(Artist.class); //{id = , name = , genre = }
                    mArtists.add(artist);
                }

                mArtistArrayAdapter = new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_list_item_1, mArtists);
